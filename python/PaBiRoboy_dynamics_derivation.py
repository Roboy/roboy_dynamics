...
lighthouse_sensor[0].set_pos(ankle_left, 0.03 * lower_leg_left_frame.y)
lighthouse_sensor[1].set_pos(knee_left, 0.13 * upper_leg_left_frame.y)
lighthouse_sensor[2].set_pos(knee_left, 0.31 * upper_leg_left_frame.y)
lighthouse_sensor[3].set_pos(hip_left,  (-0.09 * hip_frame.x)+(0.055 * hip_frame.y))
lighthouse_sensor[4].set_pos(hip_left, (hip_length/2 * hip_frame.x)+(0.02 * hip_frame.y))
lighthouse_sensor[5].set_pos(hip_right, (0.09 * hip_frame.x)+(0.055 * hip_frame.y))
lighthouse_sensor[6].set_pos(knee_right, 0.30 * upper_leg_right_frame.y)
lighthouse_sensor[7].set_pos(knee_right, 0.095 * upper_leg_right_frame.y)
lighthouse_sensor[8].set_pos(ankle_right, 0.04 * lower_leg_right_frame.y)
lighthouse_frame = []
