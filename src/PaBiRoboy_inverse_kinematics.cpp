...
void PaBiRoboyInverseKinematics::lighthouse_sensor(double *out, int sensor, double ankle_x, double ankle_y, double theta0, double theta1, double theta2, double theta3, double phi) {
   switch(sensor){
       case 0:
